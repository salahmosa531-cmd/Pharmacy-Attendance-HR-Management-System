...
class ShiftClosure extends Equatable {
  ...
  factory ShiftClosure.fromMap(Map<String, dynamic> map) {
    return ShiftClosure(
      ...
      totalCardSales: (map['total_card_sales'] as num).toDouble(),
      totalWalletSales: (map['total_wallet_sales'] as num).toDouble(),
      totalInsuranceSales: (map['total_insurance_sales'] as num).toDouble(),
      totalCreditSales: (map['total_credit_sales'] as num).toDouble(),
